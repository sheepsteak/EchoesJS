...
using Sheepsteak.EchoesJS.UI.Features.Main;
...
namespace Sheepsteak.EchoesJS.UI
{
    public class AppBootstrapper : PhoneBootstrapperBase
    {
        ...
        {
            ConventionManager.AddElementConvention<UI.Controls.LongListSelector>(UI.Controls.LongListSelector.ItemsSourceProperty, "SelectedItem", "SelectionChanged").ApplyBinding =
                (viewModelType, path, property, element, convention) =>
                {
                    if (!ConventionManager.SetBindingWithoutBindingOrValueOverwrite(
                        viewModelType, path, property, element, convention, UI.Controls.LongListSelector.ItemsSourceProperty))
                    {
                        return false;
                    }

                    ApplyLongListSelectorItemTemplate((UI.Controls.LongListSelector)element, property);
                    ConventionManager
                        .ConfigureSelectedItem(element, UI.Controls.LongListSelector.SelectedItemProperty, viewModelType, path);
        ...
        private static void ApplyLongListSelectorItemTemplate(UI.Controls.LongListSelector longlistSelector, PropertyInfo property)
        {
